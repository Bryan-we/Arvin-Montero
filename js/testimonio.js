const wrapper = document.querySelector(".testimonio__contenido");
const carousel = document.querySelector(".testimonio__carousel");
const firstCardWidth = carousel.querySelector(".testimonio__info").offsetWidth;
const arrowBtns = document.querySelectorAll(".testimonio__contenido i");
...
const dragging = (e) => {
  if (!isDragging) return; // if isDragging es un retorno falso desde aquí
